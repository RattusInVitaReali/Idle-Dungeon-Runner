...
const UpgradeRequirement = preload("res://UI/FullScreenPopup/SlottableInspector/SkillInspector/UpgradeRequirement/UpgradeRequirement.tscn")

onready var skill_tags = $Panel/VBoxContainer/SkillTags
onready var skill_level = $Panel/VBoxContainer/SkillLevel
onready var skill_description = $Panel/VBoxContainer/SkillDescription
...
func _on_Equip_pressed():
	slottable.try_equip(!slottable.equipped)
